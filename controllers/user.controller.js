...
export const logout = async (req, res) => {
  try {
    const access = req.body?.accessToken || getBearerToken(req);
    const refresh = req.body?.refreshToken || null;
    ...
    if (usingRefresh && refresh && user.refreshToken !== refresh) {
...
export const refreshToken = async (req, res) => {
  try {
    const refresh = req.body?.refreshToken || getBearerToken(req);
